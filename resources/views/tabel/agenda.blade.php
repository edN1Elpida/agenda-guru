            ...
            <div class="card-header pb-0">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="../tambah/agenda"><i class="fas fa-plus"></i>&nbsp;&nbsp;</a>
                    </div>
                  </div>
            </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr scope="row">
                      ...
                      <td>
                        <a class="btn btn-link ms-auto text-end text-dark px-3 mb-0" href="/viewagenda/{{$row->id}}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                        <a class="btn btn-link ms-auto text-end text-danger text-gradient px-3 mb-0" href="/deleteagenda/{{$row->id}}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
